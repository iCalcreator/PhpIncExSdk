...
class RecordPattern extends ValidateBase
{
    /**
     * RecordPattern
     *
    ...
    public static function check( Dto $dto, ?array & $result = [], ?string $upper = '' ) : bool
    {
        ...
        if( ! self::extAttrOk( $dto->getOffsetunit(), $dto->isExtOffsetunitSet(), $errExt )) {
            $return = false;
            self::updResultWithErrExtUse( $upper, self::OFFSETUNIT, $errExt, $result );
        }
