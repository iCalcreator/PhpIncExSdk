...
use Kigkonsult\PhpIncExSdk\Dto\Platform as Dto;

class Platform implements JsonInterface
{
    /**
     * Parse json array to populate new Platform
     *
    ...
    /**
     * Write Platform Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
