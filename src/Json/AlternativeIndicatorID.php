...
use Kigkonsult\PhpIncExSdk\Dto\AlternativeIndicatorID as Dto;

class AlternativeIndicatorID implements JsonInterface
{
    /**
     * Parse json array to populate new AlternativeIndicatorID
     *
    ...
    /**
     * Write AlternativeIndicatorID Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
