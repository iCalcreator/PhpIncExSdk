...
class ServiceName implements JsonInterface
{
    /**
     * Parse json array to populate new ServiceName
     *
    ...
    public static function parse( array $jsonArray ) : Dto
    {
        ...
        if( isset( $jsonArray[self::IANASERVICE] )) {
            $dto->setIanaService( $jsonArray[self::IANASERVICE] );
        }
        if( isset( $jsonArray[self::URL] )) {
            foreach( $jsonArray[self::URL] as $subJsonArray ) {
                $dto->addUrl( $subJsonArray );
            }
        }
    ...
    /**
     * Write ServiceName Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
    public static function write( Dto $dto ) : object
    {
        ...
        if( $dto->isIanaServiceSet()) {
            $jsonArray[self::IANASERVICE] = $dto->getIanaService();
        }
        if( $dto->isUrlSet()) {
            $jsonArray[self::URL] = [];
