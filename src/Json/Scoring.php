...
use Kigkonsult\PhpIncExSdk\Dto\Scoring as Dto;

class Scoring implements JsonInterface
{
    /**
     * Parse json array to populate new Scoring
     *
    ...
    /**
     * Write Scoring Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
