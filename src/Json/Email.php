...
class Email implements JsonInterface
{
    /**
     * Parse json array to populate new Email
     *
    ...
    public static function parse( array $jsonArray ) : Dto
    {
        ...
        if( isset( $jsonArray[self::EMAILTO] )) {
            $dto->setEmailTo( $jsonArray[self::EMAILTO] );
        }
    ...
    /**
     * Write Email Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
    public static function write( Dto $dto ) : object
    {
        ...
        if( $dto->isEmailToSet()) {
            $jsonArray[self::EMAILTO] = $dto->getEmailTo();
        }
