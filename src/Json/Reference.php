...
class Reference implements JsonInterface
{
    /**
     * Parse json array to populate new Reference
     *
    ...
    public static function parse( array $jsonArray ) : Dto
    {
        ...
        if( isset( $jsonArray[self::REFERENCENAME] )) {
            $dto->setReferenceName( ReferenceName::parse( $jsonArray[self::REFERENCENAME] ));
        }
    ...
    /**
     * Write Reference Dto properties to json array
     *
     * @param Dto $dto
     * @return object
     */
    public static function write( Dto $dto ) : object
    {
        ...
        if( $dto->isReferenceNameSet()) {
            $jsonArray[self::REFERENCENAME] = ReferenceName::write( $dto->getReferenceName());
        }
        if( $dto->isUrlSet()) {
            $jsonArray[self::URL] = [];
