...
trait ExtCategoryTrait
{
     ...
     * @return bool
     */
    public function isExtCategorySet() : bool
    {
        return ( null !== $this->extCategory );
    }

    /**
     * @param string|null $extCategory
     * @return static
     */
    public function setExtCategory( ? string $extCategory = null ) : static
    {
