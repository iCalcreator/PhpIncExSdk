...
/**
 * The AlternativeID class lists the tracking numbers used by CSIRTs, other than the one generating the document,
 * to refer to the identical activity described in the IODEF document.  A tracking number listed as an AlternativeID
 * references the same incident detected by another CSIRT.  The tracking numbers of the CSIRT that generated the IODEF
 * document must never be considered an AlternativeID.
 *
 * AlternativeID MUST have at least one instance of IncidentID
 */
class AlternativeID extends DtoBase
{
    /**
     * Factory method with required IncidentID properties
     *
