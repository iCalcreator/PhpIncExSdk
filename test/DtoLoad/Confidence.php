...
class Confidence extends DtoLoadBase
{
    /**
     * Use faker to populate new Confidence
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $rating = ( 2 < $faker->randomDigitNotNull ) ? $faker->rfc7970ConfidenceRating() : self::EXT_VALUE;
        $dto->setRating( $rating );
        if( self::EXT_VALUE === $rating ) {
            $dto->setExtRating( $faker->word());
        }
