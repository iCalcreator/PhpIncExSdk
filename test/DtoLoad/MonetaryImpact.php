...
class MonetaryImpact extends DtoLoadBase
{
    /**
     * Use faker to populate new MonetaryImpact
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $dto->setValue( $faker->randomNumber( 5, true ));
        ...
        $dto->setCurrency( $faker->currencyCode());
