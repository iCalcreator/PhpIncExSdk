...
use Exception;
use Faker;
use Kigkonsult\PhpIncExSdk\Dto\ServiceName as Dto;

class ServiceName extends DtoLoadBase
{
    /**
     * Use faker to populate new ServiceName
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $dto->setIanaService((string) $faker->numberBetween( 0, 46 ));
