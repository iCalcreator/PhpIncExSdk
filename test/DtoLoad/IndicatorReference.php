...
class IndicatorReference extends DtoLoadBase
{
    /**
     * Use faker to populate new IndicatorReference
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $dto->setEuidRef( $faker->uuid());

        $dto->setVersion( $faker->word . $faker->semver());
