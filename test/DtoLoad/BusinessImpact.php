...
use Kigkonsult\PhpIncExSdk\Dto\BusinessImpact as Dto;

class BusinessImpact extends DtoLoadBase
{
    /**
     * Use faker to populate new BusinessImpact
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $type = $faker->rfc7970BusinessImpactType();
        $dto->setType( $type );
