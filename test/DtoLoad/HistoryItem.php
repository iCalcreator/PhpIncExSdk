...
class HistoryItem extends DtoLoadBase
{
    /**
     * Use faker to populate new HistoryItem
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $action = ( 2 < $faker->randomDigitNotNull ) ? $faker->rfc7970HistoryItemAction() : self::EXT_VALUE;
