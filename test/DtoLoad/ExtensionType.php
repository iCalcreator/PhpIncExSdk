...
class ExtensionType extends DtoLoadBase
{
    /**
     * Use faker to populate new ExtensionType
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $dtype = ( 2 < $faker->randomDigitNotNull ) ? $faker->rfc7970ExtensionTypeDtype() : self::EXT_VALUE;
        $dto->setDtype( $dtype );
