...
class SystemImpact extends DtoLoadBase
{
    /**
     * Use faker to populate new SystemImpact
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        // NO ref in  https://www.iana.org/assignments/iodef2/iodef2.xhtml
        $completion = $faker->randomElement(
            [
                'failed',
                'succeeded'
            ]
        ...
        $type = ( 2 < $faker->randomDigitNotNull ) ? $faker->rfc7970SystemImpactType() : self::EXT_VALUE;
        $dto->setType( $type );
