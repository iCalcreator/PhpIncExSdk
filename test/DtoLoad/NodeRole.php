...
use Kigkonsult\PhpIncExSdk\Dto\NodeRole as Dto;

class NodeRole extends DtoLoadBase
{
    /**
     * Use faker to populate new NodeRole
     *
    ...
    public static function load( ? bool $allowSelfInvokes = true ) : Dto
    {
        ...
        $category = ( 2 < $faker->randomDigitNotNull ) ? $faker->rfc7970NodeRoleCategory() : self::EXT_VALUE;
